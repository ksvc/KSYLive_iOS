...
//  Pods
//
//  Created by iVermisseDich on 2017/2/27.
//
//
...
/**
 @abstract 设置默认配置
 @discussion bInterruptOtherAudio : NO
 @discussion bDefaultToSpeaker : YES
 @discussion bAllowBluetooth : YES
 @discussion AVAudioSessionCategory : AVAudioSessionCategoryPlayAndRecord
 */
- (void)setDefaultCfg;
